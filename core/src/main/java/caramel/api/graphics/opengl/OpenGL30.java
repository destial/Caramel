package caramel.api.graphics.opengl;
...
public class OpenGL30 extends OpenGL20 implements caramel.api.graphics.GL30 {
    @Override
    ...
    @Override
    public void glBufferData(int target, float[] bufs, int mode) {
        GL30.glBufferData(target, bufs, mode);
    }

    @Override
    public void glBufferData(int target, int[] bufs, int mode) {
        GL30.glBufferData(target, bufs, mode);
    }
    ...
    @Override
    public void glBufferSubData(int target, long offset, float[] buffer) {
        GL30.glBufferSubData(target, offset, buffer);
    }

    @Override
    public void glBufferSubData(int target, long offset, int[] buffer) {
        GL30.glBufferSubData(target, offset, buffer);
    }
    ...
    public void glPolygonMode(int face, int mode) {
        GL30.glPolygonMode(face, mode);
    }

    @Override
    public void glBufferData(int target, long size, int mode) {
        GL30.glBufferData(target, size, mode);
    }

    @Override
    public int glGetShaderi(int shader, int pname) {
        return GL30.glGetShaderi(shader, pname);
    }

    @Override
    public String glGetShaderInfoLog(int shader, int maxLength) {
        return GL30.glGetShaderInfoLog(shader, maxLength);
    }

    @Override
    public int glGetProgrami(int program, int pname) {
        return GL30.glGetProgrami(program, pname);
    }
    ...
    public void glUniformMatrix4fv(int location, boolean transpose, FloatBuffer buffer) {
        GL30.glUniformMatrix4fv(location, transpose, buffer);
    }

    @Override
    public void glUniform1iv(int location, int[] value) {
        GL30.glUniform1iv(location, value);
    }
}
