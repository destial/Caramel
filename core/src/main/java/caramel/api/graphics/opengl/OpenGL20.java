...
public class OpenGL20 implements caramel.api.graphics.GL20 {
    ...
    private void ensureBufferCapacity (int numBytes) {
        if (buffer == null || buffer.capacity() < numBytes) {
            buffer = MemoryUtil.memAlloc(numBytes);
    ...
    public void glDrawElements (int mode, int count, int type, Buffer indices) {
        if (indices instanceof ShortBuffer && type == caramel.api.graphics.GL20.GL_UNSIGNED_SHORT) {
            ...
            sb.limit(oldLimit);
        } else if (indices instanceof ByteBuffer && type == caramel.api.graphics.GL20.GL_UNSIGNED_SHORT) {
            ...
            GL11.glDrawElements(mode, sb);
            sb.limit(oldLimit);
        } else if (indices instanceof ByteBuffer && type == caramel.api.graphics.GL20.GL_UNSIGNED_BYTE) {
