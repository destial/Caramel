...
// );
    ...
    void glBufferData(int target, float[] bufs, int mode);

    void glBufferData(int target, int[] bufs, int mode);

    void glDeleteVertexArrays(int arrays);

    void glDeleteBuffers(int buffers);

    void glBufferSubData(int target, long offset, float[] buffer);

    void glBufferSubData(int target, long offset, int[] buffer);
    ...
    void glBufferData(int target, long size, int mode);
